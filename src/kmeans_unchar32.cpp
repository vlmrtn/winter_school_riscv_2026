    ...
    public:
        ...
        void operator()(const cv::Range& range) const CV_OVERRIDE
        {
            ...
            for (int i = begin; i < end; i++)
            {
                ...
                vuint8m1_t dI_uint8 = __riscv_vle8_v_u8m1(dI, vl);
                vuint16m2_t dI_uint16 = __riscv_vwcvtu_x_x_v_u16m2(dI_uint8, vl);
                vfloat32m4_t dI_f32 = __riscv_vfwcvt_f_xu_v_f32m4(dI_uint16, vl);

                vuint8m1_t dCI_uint8 = __riscv_vle8_v_u8m1(dCI, vl);
                vuint16m2_t dCI_uint16 = __riscv_vwcvtu_x_x_v_u16m2(dCI_uint8, vl);
                vfloat32m4_t dCI_f32 = __riscv_vfwcvt_f_xu_v_f32m4(dCI_uint16, vl);

                vfloat32m4_t diff = __riscv_vfsub_vv_f32m4(dI_f32, dCI_f32, vl);
                vfloat32m4_t diff_sqr = __riscv_vfmul_vv_f32m4(diff, diff, vl);
                acc = __riscv_vfredusum_vs_f32m4_f32m1(diff_sqr, acc, vl);
        ...
        int K, RNG& rng, int trials)
    {
        ...
        for (int k = 1; k < K; k++)
        {
            ...
            for (int j = 0; j < trials; j++)
            {
                ...
                for (; i <= N - vl1 * 2; i += vl1 * 2)
                {
                    size_t vl = __riscv_vsetvl_e32m4(N - i);

                    vfloat32m4_t v1 = __riscv_vle32_v_f32m4(tdist2, vl);
                    temp1 = __riscv_vfadd_vv_f32m4(temp1, v1, vl);

                    vfloat32m4_t v2 = __riscv_vle32_v_f32m4(tdist2 + vl, vl);
                    temp2 = __riscv_vfadd_vv_f32m4(temp2, v2, vl);

                }
                acc1 = __riscv_vfredosum_vs_f32m4_f32m1(temp1, acc1, vl1);
                acc2 = __riscv_vfredosum_vs_f32m4_f32m1(temp2, acc2, vl1);

                s += __riscv_vfmv_f_s_f32m1_f32(acc1);
                s += __riscv_vfmv_f_s_f32m1_f32(acc2);
...
double kmeans_uchar32d(
    ...
    return stud32::kmeans(data, K, bestLabels, criteria, attempts, flags, centers);
}